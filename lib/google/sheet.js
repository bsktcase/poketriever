    ...
    return new Promise(function (resolve, reject) {
        ...
        request.resource.requests.push({
            ...
            repeatCell: {
                ...
                cell: {
                    userEnteredValue: {
                        formulaValue: '=IFERROR(INDEX(finalevo,MATCH($B2,pokename,0),1),"")'
                    }
                },
                fields: 'userEnteredValue'
            }
            ...
            repeatCell: {
                ...
                cell: {
                    userEnteredValue: {
                        formulaValue: '=IFERROR(FLOOR((ARRAYFORMULA(INDEX(baseattack,MATCH($Q2,pokename,0),1))+$I2)*(ARRAYFORMULA(INDEX(basedefense,MATCH($Q2,pokename,0),1))+$J2)^0.5*(ARRAYFORMULA(INDEX(basestamina,MATCH($Q2,pokename,0),1))+$K2)^0.5*ARRAYFORMULA(INDEX(cpmultiplier,MATCH(40,levels,0),1))^2/10),"")'
                    }
                },
                fields: 'userEnteredValue'
            }
            ...
            repeatCell: {
                ...
                cell: {
                    userEnteredValue: {
                        formulaValue: '=INDEX(cumuldust,MATCH(currentlevel+1.5,levels,0),0) - INDEX(cumuldust,MATCH($H2,levels,0),0)'
                    }
                },
                fields: 'userEnteredValue'
            }
            ...
            repeatCell: {
                ...
                cell: {
                    userEnteredValue: {
                        formulaValue: '=INDEX(cumulcandy,MATCH(currentlevel+1.5,levels,0),0) - INDEX(cumulcandy,MATCH($H2,levels,0),0)'
                    }
                },
                fields: 'userEnteredValue'
            }

...
function loadPokemon() {
    let pRows = [
        // ['#', 'pokémon', 'nick', 'tag', 'grade', iv', 'cp', 'level', 'atk', 'def', 'sta', 'quick move', 'charge move', 'date captured', 'max cp @ current level', 'max cp @ 40', ' final evo', ' max cp final evo @ 40', 'stardust to max @ 32', 'candy to max @ 32']
    ];

...
function loadPokemon() {
    let pRows = [
        // ['#', 'pokémon', 'nick', 'tag', 'grade', iv', 'cp', 'level', 'atk', 'def', 'sta', 'quick move', 'charge move', 'date captured', 'final evo', 'max cp @ 32', 'max cp final evo @ 32', 'stardust to max @ 32', 'candy to max @ 32', 'max cp @ 40', 'max cp final evo @ 40']
    ];
